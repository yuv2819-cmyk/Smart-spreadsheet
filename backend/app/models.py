...
class WorkspaceSettings(Base):
    ...
    india_mode_enabled = Column(Boolean, nullable=False, default=False)
    preferred_currency = Column(String(8), nullable=False, default="USD")
    number_format = Column(String(20), nullable=False, default="international")
    fiscal_year_start_month = Column(Integer, nullable=False, default=1)
    report_language = Column(String(20), nullable=False, default="english")
